...
import { FileText, Leaf, Search, CheckCircle2, Wallet } from "lucide-react";
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-1 bg-gray-100 rounded-xl p-1 mb-4">
          ...
          <TabBtn active={tab === "eco"} onClick={() => setTab("eco")}>
            <Leaf className="w-4 h-4 inline-block mr-1.5" />
            Eco-Points
          </TabBtn>
        </div>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              <div className="bg-kku text-white px-4 py-3 flex items-center justify-between">
                ...
                {b.verified && (
                  <span className="text-[11px] bg-white/20 px-2 py-1 rounded-full flex items-center gap-1">
            ...
            <button className="w-full bg-line text-white font-bold py-3 rounded-xl text-sm flex items-center justify-center gap-2">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white rounded-2xl p-5">
              <div className="flex items-center gap-2 text-white/90 text-xs mb-1">
                ...
                <span>Eco-Points สะสม</span>
              </div>
              <div className="text-4xl font-bold mt-1">{points}</div>
              <div className="text-white/90 text-xs mt-2 flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5" />
                <span>คุณใช้ไฟต่ำกว่าค่าเฉลี่ยตึก 4 เดือนติด</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4">
                  ...
                  return (
                    <div key={m.month} className="flex-1 flex flex-col items-center gap-1">
                      <div className="w-full flex items-end justify-center gap-0.5 h-24">
                        <div
                          className={`w-2.5 rounded-t ${under ? "bg-emerald-500" : "bg-red-400"}`}
              ...
              <div className="flex gap-4 mt-3 text-[10px] text-gray-500">
                <span className="flex items-center gap-1">
                  <span className="w-2 h-2 rounded-sm bg-emerald-500 inline-block" /> ห้องคุณ
                </span>
                <span className="flex items-center gap-1">
